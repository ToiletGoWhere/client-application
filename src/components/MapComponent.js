            ...
            for (var i = 0; i < this.props.toiletData.toiletList.length; i++) {
                ...
                marker.addListener("click", evt => {
                    ...
                    this.props.dispatch({
                        type: "toiletData/save",
                        payload: {
                            currentToiletSelected: JSON.parse(
                                marker.getTitle(),
                            ),
                        },
                    });
        ...
        return (
            <div>
                ...
                <ReloadLocationButton
                    onClick={() =>
                        this.reloadLocation(this.map, this.curMarker)
                    }
                >
                    <LocationSearching />
                </ReloadLocationButton>
                ...
                {this.props.navigator.toiletInfoShow && (
                    <DirectionButton>
                        <Directions
                            onClick={() => {
                                var latDes = this.props.toiletData
                                    .currentToiletSelected.location[0];
                                var longDes = this.props.toiletData
                                    .currentToiletSelected.location[1];
                                var url =
                                ...
                                win.focus();
                                if (
                                    this.props.toiletData.currentToiletSelected
                                        .confirmed === false &&
